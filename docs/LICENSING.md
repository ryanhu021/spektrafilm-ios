...
`Sources/SpektraFilm/Data/profiles/*.json` are upstream's 28 measured film and print-paper
...
`Sources/SpektraFilm/Data/luts/spectral_upsampling/irradiance_xy_tc.npy` is upstream's
...
`Sources/SpektraFilm/Data/filters/` holds digitised transmission curves for Schott
